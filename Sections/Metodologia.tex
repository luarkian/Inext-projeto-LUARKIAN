...
\par\todo[color=green]{Sugiro descrever mais sobre este servidor web, exemplo de conexão local ou não, banco de dados e outras informações necessárias}
...
conexão com uma rede wireless 802.11 b/g/n\todo{Falar um pouco sobre baixo consumo de energia}.
