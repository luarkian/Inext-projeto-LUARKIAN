...
\todo[inline,color=red]{Sugiro descrever aquela ideia de dizer que além das transições entre as salas também é possivel identificar 
...
\todo[inline,color=green]{Sugiro descrever um pouco mais, talvez falar que com os dados de log das transições do sistema é possivel também delimitar
...
conexão com uma rede wireless 802.11 b/g/n\todo[color=green]{Falar um pouco sobre baixo consumo de energia}.
