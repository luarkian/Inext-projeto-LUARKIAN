...
\par
Na \autoref{fig:modelo}\todo{Ampliar o texto da figura} é possível notar que há um dispositivo acoplado próximo a 
...
\begin{enumerate}
    ...
    \item Configuração\todo{Sugiro mudar para Controle e monitoramento de transição dos objetos} do tempo para alertas
\end{enumerate}
...
\todo[inline]{Sugiro colocar uma foto de um objeto usando RFID}
...
\par
O sistema conterá um servidor\todo{Sugiro descrever mais sobre este servidor web, exemplo de conexão local ou não, banco de dados e outras informações necessárias} 
...
trabalhar em dois modos tanto como ponto de acesso ou no modo STA\todo{Descrever}, estação que envia e recebe dados. 
\begin{itemize}
