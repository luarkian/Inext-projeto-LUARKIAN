...
que é um sistema de localização por meio de tag RFID. As tags de referência são tags ativas colocadas \todo[color=green]{No objeto?} em pontos fixos no ambiente
...
é mais um sistema que faz uso de tags ativas, e utilizar-se de ZigBee \cite{zigbee} \todo[color=green]{Adicionar referência} para assim assegurar 
...
referência (tags ativas) para auxiliar na localização das tags \todo[color=green]{Descrever se são tags ativas ou passivas} que serão rastreadas (tags passivas).
