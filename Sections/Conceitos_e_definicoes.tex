...
Segundo \citeauthor{rodrigo2016} sistemas embarcados estão presente em quase todos os ambientes, tais sistemas possuem uma única função específica e que não pode ser alterada. Eles são controlados por microprocessadores ou microcontroladores de forma que possuem muitas restrições em relação a recursos computacionais.
    ...
    \begin{figure}[h!]
            ...
            \end{figure}
    \par
    Uma definição geral para sistemas embarcados: são sistemas que realizam uma função dedica e possuem a integração de hardware e software fortemente acoplados, geralmente são uma parte específica de um sistema maior \cite{Li:2003:RCE:829584}\todo{Falta fazer um link com IoT}.
    ...
    \todo[inline]{Falar um pouco com exemplos sobre microcontroladores como o arduino e como estes conceitos serão usados no seu tCC}
    \begin{figure}[h!]
              \caption{\label{fig:sistemas embarcados}{Arduino Nano}}
              \centering
              \includegraphics[width=0.8\textwidth]{Figuras/arduino_nano.png}
    ...
    \par
    De acordo com \citeauthor{iot2017}\todo{corrigir}, o conceito de IoT não é novo, pois desde os passos iniciais da internet ja se 
    ...
    desenvolvimento de uma infinidades de padrões e protocolos para a integração de WSN\todo{descrever} tornaram IoT uma realidade.
    \begin{figure}[H]
    ...
    \todo[inline]{Apresentar um exemplo real}
