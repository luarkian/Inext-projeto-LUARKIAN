...
\renewcommand{\primeiroMembroBanca}{Prof. MSc. }
\renewcommand{\segundoMembroBanca}{Prof. MSc. }
...
\begin{resumo}
A proliferação e adoção da Internet das Coisas (IoT) estimulou a crescente para sistema de localização em ambiente fechados tendo em vista que o sistema de posicionamento global (GPS) não funciona tão bem em tal ambiente. A tecnologia RFID facilita a construção de sistemas com baixo custo para localização e identificação de objetos. Neste trabalho propomos uma ferramenta que utilizar leitores e etiquetas RFID passivas, para o gerenciamento e controle de ativos sendo capaz de localizar e identifcar objetos etiquetados em  edificios. 

 \vspace{\onelineskip}
 
 \noindent 
 \textbf{Palavras-chaves:} localização de objetos, identificação de objetos, RFID, tag RFID passiva.
\end{resumo}
